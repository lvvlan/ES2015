...
/***/ function(module, exports, __webpack_require__) {
	...
	{
	    (function () {
	        var bar = (0, _symbol2.default)('bar');
	        var snaf = (0, _symbol2.default)('snaf');
	...
	//继承
	{
	    ...
	    var Coder = function (_Worker) {
	        (0, _inherits3.default)(Coder, _Worker);

	        function Coder(name, age, sexy) {
	            (0, _classCallCheck3.default)(this, Coder);

	            var _this = (0, _possibleConstructorReturn3.default)(this, (Coder.__proto__ || (0, _getPrototypeOf2.default)(Coder)).call(this, name, age));

	            _this.sexy = sexy;
	            return _this;
	        }

	        (0, _createClass3.default)(Coder, [{
	            key: 'sayHello',
